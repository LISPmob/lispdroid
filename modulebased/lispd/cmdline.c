...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->control_port_help = gengetopt_args_info_help[8] ;
  args_info->map_request_retries_help = gengetopt_args_info_help[9] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVdnf:m:s:p:r:", long_options, &option_index);
